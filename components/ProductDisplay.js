  ...
  return (
    <section className={styles.productSection}>
      <div className={styles.productContent}>
        <div className={`row ${styles.myCustomGrid}productContainer`}>
          {/* Text Section */}
          <div className={`col-md-12 ${styles.myCustomGrid}`} style={{ order: 1 }}>
            ...
            <div className={styles.productActions}>
              <div className="row">
                <div className="col-6 align-items-center">
                  <button
                    className={`btn btn-outline-primary btn-block ${styles.button} ${styles.buyNow}`}
                  >
                    Buy Now
                  </button>
                </div>
                <div className="col-6">
                  <button
                    className={`btn btn-outline-primary btn-block ${styles.button} ${styles.addToCart}`}
                  >
                    Add&nbsp;to&nbsp;Cart
                  </button>
                </div>
                <div className="col-md-12 text-center">
      <button className={`btn btn-link text-white ${styles.button} ${styles.seeMoreButton} custom-button`}>
        See more
        <div className={styles.arrowContainer}>
          <Image src={arrowDown} alt="Arrow Down" width="10%" height="10%" />
          <Image src={arrowDown} alt="Arrow Down" width="10%" height="10%" />
        </div>
      </button>
    </div>
